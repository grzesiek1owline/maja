...
class Codevz_Theme {
	...
	public function __construct() {
		...
		self::$is_rtl = ( is_rtl() || isset( $_GET['rtl'] ) );
	...
	public static function plugins() {
		...
		tgmpa([
			[
				'name' 				=> 'Codevz Plus',
				'slug' 				=> 'codevz-plus',
				'source' 			=> 'https://xtratheme.com/plugins/codevz-plus.zip',
				'required' 			=> true
			],
			[
				'name' 				=> $activated ? 'WPBakery Page Builder' : 'WPBakery Page Builder [Activate your theme then install this plugin]',
				'slug' 				=> 'js_composer',
				'source' 			=> $activated ? 'https://xtratheme.com/plugins/js_composer.zip' : '',
				'required' 			=> true
			],
			[
				'name' 				=> $activated ? 'Revolution Slider' : 'Revolution Slider [Activate your theme then install this plugin]',
				'slug' 				=> 'revslider',
				'source' 			=> $activated ? 'https://xtratheme.com/plugins/revslider.zip' : '',
				'required' 			=> true
			],
			[
				'name' 				=> 'Woocommerce',
...
// Theme update
function codevz_check_theme_update( $transient ) {
	...
	if ( empty( $versions ) ) {
		$request = wp_remote_get( $server . 'plugins/versions.json' );
	...
	if ( version_compare( $theme->get( 'Version' ), $versions['themes']['xtra']['version'], '<' ) ) {

		$transient->response['xtra'] = [
			'theme' 		=> 'xtra',
			'new_version' 	=> $versions['themes']['xtra']['version'],
			'url' 			=> 'https://xtratheme.com/',
			'package' 		=> $activate ? $server . 'plugins/xtra.zip' : 'error',
		];
...
add_filter( 'pre_set_site_transient_update_themes', 'codevz_check_theme_update' );

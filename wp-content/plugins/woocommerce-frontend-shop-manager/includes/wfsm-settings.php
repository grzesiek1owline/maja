...
class XforWC_Live_Editor_Settings {
		...
		$plugins['live_editor'] = array(
			...
			'settings' => array(
				...
				'wc_settings_wfsm_logo' => array(
					...
					'type' => 'text',
					'desc' => esc_html__( 'Use custom logo. Paste in the logo URL. Use square images (200x200px)!', 'woocommerce-frontend-shop-manager' ),
	...
	"bannana" : "Yellow Bananna"
		...
		foreach ( $plugins['live_editor']['settings'] as $k => $v ) {
			$get = isset( $v['translate'] ) ? $v['id'] . '_' . SevenVX()->language() : $v['id'];

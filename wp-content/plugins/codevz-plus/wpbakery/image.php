	...
	public function out( $atts, $content = '' ) {
		...
		if ( isset( $public ) || Codevz_Plus::$vc_editable || Codevz_Plus::$is_admin ) {
			...
			$css_array = array(
				...
				'sk_css_hover' 		=> $css_id . ':hover .cz_image_in, .cz_content_box:hover ' . $css_id . ' .cz_image_in',
				'sk_caption' 		=> $css_id . ' .cz_image_caption',
				'sk_caption_hover' 	=> $css_id . ':hover .cz_image_caption, .cz_content_box:hover ' . $css_id . ' .cz_image_caption',
		...
		// Out
		$out = $a_before . '<div id="' . $atts['id'] . '"' . Codevz_Plus::classes( $atts, $classes ) . $tooltip . Codevz_Plus::data_stlye( $css, $css_t, $css_m ) . '><div class="' . ( $atts['svg_bg'] ? 'cz_svg_bg' : '' ) . '"><div class="cz_image_in"' . Codevz_Plus::tilt( $atts ) . '><div class="cz_main_image">' . $image . '</div>' . $hover_image_tag . '</div>' . $caption . '</div></div>' . $a_after;

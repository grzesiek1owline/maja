...
class Codevz_WPBakery_image_hover_zoom {
	...
	public function out( $atts, $content = '' ) {
		...
		// Out
		$out = '<div id="' . $atts['id'] . '"' . Codevz_Plus::classes( $atts, $classes ) . Codevz_Plus::data_stlye( $css, $css_t, $css_m ) . '><div><a href="' . $link . '">' . $img . '</a></div></div>';

		return Codevz_Plus::_out( $atts, $out, [ 'image_zoom' ] );
	}
}
...
class Codevz_WPBakery_video_popup {
	...
	public function out( $atts, $content = '' ) {
		...
		if ( $atts['type'] === '2' && $atts['mp4'] ) {
			...
			$content_html = '<div style="display:none;" id="' . $atts['id'] . '_mp4"><video class="lg-video-object lg-html5" controls="" preload="none"><source src="' . esc_attr( $atts['mp4'] ) . '" type="video/mp4">Your browser does not support HTML5 video.</video></div>';
		}

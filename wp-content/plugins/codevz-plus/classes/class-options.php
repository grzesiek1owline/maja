	...
	public static function css_out( $is_customize_preview = 0, $single_page = 0, $post_id = '' ) {
		...
		foreach ( $opt as $id => $val ) {
			if ( $val && Codevz_Plus::contains( $id, '_css_' ) ) {
				...
				if ( $id === '_css_container_header_5' || $id === '_css_row_header_5' || Codevz_Plus::contains( $selector, ':focus' ) ) {
				...
				// RTL
				if ( ! empty( $rtl ) ) {
					$sp = Codevz_Plus::contains( $selector, array( '.cz-cpt-', '.cz-page-', '.home', 'body', '.woocommerce', '.single-post' ) ) ? '' : ' ';
		...
		if ( apply_filters( 'codevz_responsive_mode', 1 ) ) {
			...
			if ( function_exists( 'is_woocommerce' ) && Codevz_Plus::option( 'woo_two_col_mobile' ) ) {
				$rsc3 .= '.woocommerce ul.products li.product, .woocommerce-page ul.products li.product, .woocommerce-page[class*=columns-] ul.products li.product, .woocommerce[class*=columns-] ul.products li.product{width: 48% !important}';
			}
		...
		if ( $i ) {
			...
			return array(
				...
				array(
					'id' 			=> '_css_inner_title',
					'type' 			=> 'cz_sk',
					'title' 		=> esc_html__( 'Title above content', 'codevz' ),
					'button' 		=> esc_html__( 'Title above content', 'codevz' ),
					'setting_args' 	=> [ 'transport' => 'postMessage' ],
					'settings' 		=> array( 'color', 'font-size', 'padding' ),
	...
	public static function options() {
		...
		$options[]   = array(
			...
			'sections' => array(
				...
				array(
					'name'   => 'styling',
					'title'  => esc_html__( 'Colors & Styles', 'codevz' ),
					'fields' => array(
						array(
							'id'        => 'site_color',
							'type'      => 'color_picker',
						...
						array(
							...
							'selector' 		=> 'form button:hover,.cz_btn:hover,.wpcf7-submit:hover,.dwqa-questions-footer .dwqa-ask-question a:hover,input[type=submit]:hover,input[type=button]:hover,.button:hover,.cz_header_button:hover,.woocommerce a.button:hover,.woocommerce input.button:hover,.woocommerce #respond input#submit.alt:hover,.woocommerce a.button.alt:hover,.woocommerce button.button.alt:hover,.woocommerce input.button.alt:hover,.woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, #edd-purchase-button:hover, .edd-submit:hover, [type=submit].edd-submit:hover, .edd-submit.button.blue:hover, .edd-submit.button.blue:focus,.woocommerce #payment #place_order:hover, .woocommerce-page #payment #place_order:hover,.woocommerce div.product form.cart .button:hover'
						),
						array(
						...
						array(
							...
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'background', 'padding', 'border' ),
							'selector'    	=> '.page_content img, footer img, .cz_image img, .wp-block-gallery figcaption'
						),
						array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							'id' 		=> 'share_tooltip',
							'type' 		=> 'switcher',
							'title' 	=> esc_html__( 'Share Tooltip', 'codevz' )
						),

						array(
							'id' 		=> 'share_title',
							'type' 		=> 'switcher',
							'title' 	=> esc_html__( 'Share Inline Title', 'codevz' )
						),

						array(
							'id' 		=> 'share_color',
							'type' 		=> 'select',
							'title' 	=> esc_html__( 'Share color mode', 'codevz' ),
							'options' 	=> array(
						...
						array(
							...
							'type' 			=> 'cz_sk',
							'title' 		=> esc_html__( 'Share Icons', 'codevz' ),
							'button' 		=> esc_html__( 'Share Icons', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
						...
						array(
							...
							'selector' 		=> '.xtra-share a:after',
							'dependency' 	=> [ 'share_tooltip', '!=', '' ]
						),
				...
				array(
					...
					'fields'  => [
						[
							...
							'options' 		=> [
								'menu'			=> esc_html__( 'Xtra Admin Menu', 'codevz' ),
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							//	'cz' 			=> esc_html__( '----- SIMPLE MESSAGE -----', 'codevz' )
							//]),
							'setting_args'  => [ 'transport' => 'postMessage' ]
						),
						array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'type' 			=> 'cz_sk',
							'title' 		=> esc_html__( 'Posts Content', 'codevz' ),
							'button' 		=> esc_html__( 'Posts Content', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
					...
					'fields' => array(
						...
						array(
							...
							'options' 	=> array(
								...
								'mbot'		=> esc_html__( 'Meta in Title', 'codevz' ),
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'selector' 		=> '.single-post .section_title',
						),
						array(
						...
						array(
							...
							'type' 			=> 'cz_sk',
							'title' 		=> esc_html__( 'Post meta', 'codevz' ),
							'button' 		=> esc_html__( 'Post meta', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'color', 'background', 'font-size', 'border' ),
						...
						array(
							...
							'type' 			=> 'cz_sk',
							'title' 		=> esc_html__( 'Post meta icon', 'codevz' ),
							'button' 		=> esc_html__( 'Post meta icon', 'codevz' ),
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'color', 'background', 'font-size', 'border' ),
						...
						array(
							...
							'setting_args'  => [ 'transport' => 'postMessage' ],
							'settings'    => array( 'background', 'padding', 'border' ),
							'selector'    => '.single-post .cz_related_post .cz_post_image'
						),
						array(
						...
						array(
							...
							'type' => 'cz_sk_hidden',
							'setting_args' => [ 'transport' => 'postMessage' ],
							'selector'    => '.single-post .cz_related_post:hover .cz_post_image'
						),
						array(
						...
						array(
							...
							'type' 			=> 'cz_sk_hidden',
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'selector' 		=> '.single-post .cz_related_post_date a:hover'
						),
						array(
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'setting_args'  => [ 'transport' => 'postMessage' ],
								'settings'    => array( 'background', 'padding', 'border' ),
								'selector'    => '.single-' . $cpt . ' .cz_related_post .cz_post_image'
							),
							array(
								'id' => '_css_related_posts_img_' . $cpt . '_hover',
								'type' => 'cz_sk_hidden',
								'setting_args' => [ 'transport' => 'postMessage' ],
								'selector'    => '.single-' . $cpt . ' .cz_related_post:hover .cz_post_image'
							),
							array(
							...
							array(
								...
								'hover_id' 		=> '_css_related_posts_' . $cpt . '_meta_links_hover',
								'type' 			=> 'cz_sk',
								'title' 		=> esc_html__( 'Related meta links', 'codevz' ),
								'button' 		=> esc_html__( 'Related meta links', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
							...
							array(
								'id' 			=> '_css_related_posts_' . $cpt . '_meta_links_hover',
								'type' 			=> 'cz_sk_hidden',
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'selector' 		=> '.single-' . $cpt . ' .cz_related_post_date a:hover'
							),
							array(
						...
						'fields' => wp_parse_args(
							array(
								...
								array(
									...
									'type'  		=> 'switcher',
									'title' 		=> esc_html__( 'Sinlge ajax add to cart', 'codevz' )
								),
								array(
									'id'    		=> 'woo_cart',
									'type'  		=> 'text',
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'type' 			=> 'cz_sk',
								'title' 		=> esc_html__( 'Sale', 'codevz' ),
								'button' 		=> esc_html__( 'Sale', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
							...
							array(
								...
								'type' 			=> 'cz_sk',
								'title' 		=> esc_html__( 'Wishlist, Quick view Wrap', 'codevz' ),
								'button' 		=> esc_html__( 'Wishlist, Quick view Wrap', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
							...
							array(
								...
								'type' 			=> 'cz_sk',
								'title' 		=> esc_html__( 'Quick View Popup', 'codevz' ),
								'button' 		=> esc_html__( 'Quick View Popup', 'codevz' ),
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'background', 'border', 'box-shadow' ),
